...
<body>
    <div id="bg">
        <nav class="navbar bg-primary navbar-primary" style="background-color: #37517e">
            <div class="container">
                <div class="d-flex justify-content-start align-items-center">
                    <img src="../assets/img/logospekta.png" class="me-3" alt="SPEKTA by DPUPR Kabupaten Tegal" style="max-height: 45px">
        ...
        <div class="row mx-3 py-5">
            <div class="col-md-8 mx-auto">
                <div class="p-2 bg-white round-right shadow round-left-m"">              
                        ...
                        <table class="table table-bordered">
                            <thead class="h6">
                                <tr>
                                    ...
                                    <th width="50%" colspan="2" class="text-center">Uraian</th>
        ...
        <nav class="navbar bg-primary navbar-primary" style="background-color: #37517e">
            <div class="container d-flex align-items-center">
                <p class="small fw-bold text-white">SPEKTA v1.0 | Developed by <a style="color:#47b2e4" href="https://dpupr.tegalkab.go.id/">DPUPR Kabupaten Tegal</a></p>
            </div>
        </nav>
    </div>
